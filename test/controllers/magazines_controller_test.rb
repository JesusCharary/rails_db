...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { code: @magazine.code, issn: @magazine.issn } }, as: :json
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { code: @magazine.code, issn: @magazine.issn } }, as: :json
    assert_response 200
  end
